          ...
          >
            <div onClick={(e) => e.stopPropagation()} className="relative ">
              <div className="border-4 border-[#9AC0B5]  rounded-lg  shadow-lg flex flex-row justify-center items-center  bg-white outline-none focus:outline-none ">
                <div className="flex flex-col h-[500px] p-10 border ">
                  ...
                  <div className="flex flex-row justify-center items-center gap-[25px] ">
                    <div className="flex flex-col items-center  gap-[15px] w-[330px]  h-[350px] pt-10">
                      ...
                      <button
                        className="border w-fit p-2 border-[#9AC0B5]  hover:border-none "
                        onClick={() => {
                          handleClickShowProPic(pics[0]?.id, { isShow: true });
                        }}
                      >
                        choose this photo as first pic
                      </button>
                    </div>

                    <div className="flex flex-col gap-[15px] w-[330px]  h-[350px] pt-10">
                      <input
                        type="file"
                        className="absolute invisible"
                        ref={inputEl2}
