					...
					<div className="flex flex-row gap-[20px]">
						{pathname == `/profile/${user?.id}` ? (
							<button
								...
								className="flex flex-row justify-center items-center bg-[#9AC0B5] text-white font-bold rounded-[20px] w-[180px] h-[60px] hover:bg-[#74A899] transition delay-20"
							>
								Wallet: {user?.wallet.toLocaleString()} THB
							</button>
						) : (
							""
						)}
						...
						{user.providerRequestStatus === "SUCCESS" ? (
							<button
								...
								className={`flex flex-row justify-center items-center bg-[#9AC0B5] text-white font-bold rounded-[20px] w-[140px] h-[60px] hover:bg-[#74A899] transition delay-20 ${
