	...
	return (
		<>
			<div className="px-40 py-2 flex w-full justify-between items-center absolute z-10">
				...
				<div className=" w-1/2 justify-end  gap-6 flex flex-row items-center">
					<a className="text-[#809490] font-bold lg:text-2xl text-xl hover:text-[#98ABA7] cursor-pointer">
						Home
					</a>
					<a
						onClick={handleClick}
						className="text-[#809490] font-bold lg:text-2xl text-xl hover:text-[#98ABA7] cursor-pointer"
					>
						About us
					</a>
					<a className="text-[#809490] font-bold lg:text-2xl text-xl hover:text-[#98ABA7] cursor-pointer">
			...
			<div className="flex space-x-[100px] px-[180px] pt-[80px] pb-[100px]">
				<div>
					<img src={party} className=" rounded-lg w-[500px] h-[200px]" />
					<p className="text-center  text-[#224957] text-[20px] mt-4 font-medium">
						Party
					</p>
				</div>
				<div>
					<img src={tutor} className=" rounded-lg w-[500px] h-[200px]" />
					<p className="text-center  text-[#224957] text-[20px] mt-4 font-medium">
						Tutor
					</p>
				</div>
				<div>
					<img src={diving} className=" rounded-lg w-[500px] h-[200px]" />
					<p className="text-center  text-[#224957] text-[20px] mt-4 font-medium">
						Diving
					</p>
				</div>
