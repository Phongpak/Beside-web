				...
				<div className="flex flex-row gap-10">
					...
					<div className="flex flex-col   h-[650px]">
						<div className="flex flex-col gap-[10px]">
							...
							{isEditing ? (
								<button
									className="mx-auto mt-20 flex flex-row justify-center items-center bg-[#9AC0B5] text-white font-bold rounded-[20px] w-[140px] h-[60px] hover:bg-[#74A899] transition delay-20"
